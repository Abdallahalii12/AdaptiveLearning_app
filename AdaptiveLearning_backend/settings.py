"""
Django settings for AdaptiveLearning_backend project.
...
# Add Anaconda site-packages to Python path
...
SECRET_KEY = "django-insecure-#_7n638xjxunm0(se4ejl6-61ymgp!)qs4enl&i(x&%vm-6k22"
...
ROOT_URLCONF = "AdaptiveLearning_backend.urls"
...
WSGI_APPLICATION = "AdaptiveLearning_backend.wsgi.application"
